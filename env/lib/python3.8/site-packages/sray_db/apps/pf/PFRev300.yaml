app_name: PreferencesFilterRev
description: Preferences Filter Revenues. Float columns indicate the percentage \
             of a companies revenue assocated with the given filter topic.
frequency: Daily
hierarchy: entity
outputs:
- field_name: assetid
...
- field_name: palm_rev
  ...
  type: Float
- field_name: pla_rev
  description: Plastic Production
  primary_key: false
  type: Float
- field_name: por_rev
  description: Pork
