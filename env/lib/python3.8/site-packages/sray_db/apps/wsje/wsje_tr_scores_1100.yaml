...
outputs:
  ...
  - description: Date
    ...
    primary_key: true
    type: Date
  - description: Thomson Reuters report date
  ...
  - description: Does the company report on initiatives to reduce, reuse, recycle, substitute, or phase out SOx (sulfur oxides) or NOx (nitrogen oxides) emissions? This input score originates from the datapoint trd_180.
    ...
    primary_key: false
    type: Float
  - description: Does the company report on initiatives to reduce, substitute, or phase out volatile organic compounds (VOC)? This input score originates from the datapoint trd_183.
    field_name: tr_533
    primary_key: false
    type: Float
  ...
  - description: Does the company claim to produce or distribute wood or forest products that are labeled? This input score originates from the datapoint trd_224.
    ...
    primary_key: false
    type: Float
  - description: Does the company reports about take-back procedures and recycling programs to reduce the potential risks of products entering the environment? This input score originates from the datapoint trd_226.
    field_name: tr_546
    primary_key: false
    type: Float
  ...
  - description: Does the company have an environmental management team? This input score originates from the datapoint trd_239.
    ...
    primary_key: false
    type: Float
  - description: Does the company have a policy to improve its water efficiency? This input score originates from the datapoint trd_241.
    field_name: tr_553
    primary_key: false
    type: Float
  - description: Does the company have a policy to improve its energy efficiency? This input score originates from the datapoint trd_242.
    field_name: tr_554
    primary_key: false
    type: Float
  - description: Does the company have a policy to improve its use of sustainable packaging? This input score originates from the datapoint trd_243.
    ...
    primary_key: false
    type: Float
  - description: Has the company set targets or objectives to be achieved on energy efficiency? This input score originates from the datapoint trd_246.
    field_name: tr_556
    primary_key: false
    type: Float
  ...
  - description: Does the company report about environmentally friendly or green sites or offices? This input score originates from the datapoint trd_259.
    ...
    primary_key: false
    type: Float
  - description: Does the company use environmental or sustainable criteria in the selection process of its suppliers or sourcing partners? This input score originates from the datapoint trd_263.
    field_name: tr_560
    primary_key: false
    type: Float
  ...
  - description: Does the company provide flexible working schemes? This input score originates from the datapoint trd_350.
    ...
    primary_key: false
    type: Float
  - description: Does the company have a policy to avoid the use of child labor? This input score originates from the datapoint trd_356.
    field_name: tr_579
    primary_key: false
    type: Float
  ...
  - description: Has there has been a strike or an industrial dispute that led to lost working days? This input score originates from the datapoint trd_375.
    ...
    primary_key: false
    type: Float
  - description: Does the company have a policy to improve employee health & safety? This input score originates from the datapoint trd_383.
    field_name: tr_588
    primary_key: false
    type: Float
