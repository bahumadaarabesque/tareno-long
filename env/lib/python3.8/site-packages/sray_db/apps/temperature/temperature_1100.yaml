...
description: The Temperature Score is a metric that quantifies the extent to which corporations across the world are contributing to the rise in global temperature.
frequency: Weekly
hierarchy: entity
outputs:
- field_name: assetid
